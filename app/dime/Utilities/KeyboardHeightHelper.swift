...
@MainActor
class KeyboardHeightHelper: ObservableObject, @unchecked Sendable {
...
struct KeyboardAwareModifier: ViewModifier {
    @AppStorage("keyboard", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var savedKeyboardHeight: Double = .init(UIScreen.main.bounds.height / 2.5)
