...
struct LogView: View {
    ...
    @AppStorage("logTimeFrame", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var logTimeFrame = 2
...
struct LogInsightsView: View {
    ...
    @AppStorage("logInsightsType", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var insightsType = 1

    @AppStorage("logViewLineGraph", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var lineGraph: Bool = false
...
struct TransactionsList: View {
    ...
    @AppStorage("showUpcomingTransactions", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var showUpcoming: Bool = true
    @AppStorage("showUpcomingTransactionsWhenUpcoming", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing")) var showSoon: Bool = false
