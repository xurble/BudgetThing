...
struct SettingsNotificationsView: View {
  ...
  @AppStorage("notificationsEnabled", store: UserDefaults(suiteName: "group.farm.poplar.budgetthing"))
  ...
  var body: some View {
    VStack {
      ...
      if showNotifications {
        ...
        .onAppear {
          if UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(
            forKey: "notificationOption") != nil {
            option = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
              forKey: "notificationOption")
          }

          if UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(forKey: "customHour")
            != nil
            && UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(forKey: "customMinute")
              != nil {
            var components = DateComponents()
            components.hour = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
              forKey: "customHour")
            components.minute = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
              forKey: "customMinute")
...
func newNotification() {
  ...
  if UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(forKey: "notificationOption")
    != nil {
    option = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
      forKey: "notificationOption")
  }
  ...
  if option == 1 {
    ...
    if UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(forKey: "customHour") != nil,
      UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.object(forKey: "customMinute") != nil {
      components.hour = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
        forKey: "customHour")
      components.minute = UserDefaults(suiteName: "group.farm.poplar.budgetthing")!.integer(
        forKey: "customMinute")
